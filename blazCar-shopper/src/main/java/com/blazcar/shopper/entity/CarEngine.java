...
@Document(collection = "carEngines")
public class CarEngine {
  ...
  private CarEngineDisplacement displacement;
  private CarEngineTorque torque;
  private ItemPower power;
  private CarEngineCylinder cylinder;
  ...
  public CarEngineDisplacement getDisplacement() {
    return displacement;
  }

  public void setDisplacement(CarEngineDisplacement displacement) {
    this.displacement = displacement;
  }

  public CarEngineTorque getTorque() {
    return torque;
  }

  public void setTorque(CarEngineTorque torque) {
    this.torque = torque;
  }
  ...
  public CarEngineCylinder getCylinder() {
    return cylinder;
  }

  public void setCylinder(CarEngineCylinder cylinder) {
